...
- [ ] Загрузка и установка актуальной версии twenty CRM (git clone или архив)
- [ ] Проверка и установка зависимостей (Node.js, NestJS, PostgreSQL, Redis)
- [ ] Базовый запуск приложения в dev-режиме
- [ ] Ознакомление со структурой и best practices платформы
- [ ] Первичная настройка структуры каталогов MaK-CRM
- [ ] Фиксация исходного состояния для дальнейшей кастомизации

**Контроль после этапа:**
- Приложение успешно запускается локально
- Все зависимости установлены и рабочие
- Структура каталогов согласована с ТЗ и roadmap
- Документация по запуску обновлена

### Этап 1. Проектирование и подготовка (2 недели)
- [ ] Сбор и формализация требований, анализ пожеланий заказчика (TZ CRM.md)
- [ ] Проектирование архитектуры системы и базы данных (twenty, PostgreSQL)
- [ ] Подготовка инфраструктуры (серверы, домены, хранилища, Docker, CI/CD)
- [ ] Настройка репозитория, документации, регламентов и базовых процессов

**Контроль после этапа:**
- Проверка полноты требований (сверка с TZ CRM.md и пожеланиями заказчика)
- Валидация архитектуры с учётом масштабируемости и безопасности
- Проверка готовности инфраструктуры (CI/CD, домены, хранилища)
- Актуальность и полнота документации

### Этап 2. Базовая CRM-платформа (3-4 недели)
- [ ] Развёртывание twenty и настройка NestJS-приложения
